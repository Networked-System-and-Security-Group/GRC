...
data_to_plot = {
    'Avg FCT':    ([0,50,100,150,200], data[1]),
    'Avg intra_flow FCT': ([0,50,100,150,200], data[2]),
    'Avg inter_flow FCT': ([0,50,100,150,200], data[3])
}
...
plot_auto_lines(
    ...
    filename="dynamic_flow_analysis_avg.pdf",
