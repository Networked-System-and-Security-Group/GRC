...
# 这里绘制动态流量
# 纵轴为FCT，横轴为inter_load，分别为0,50,100,150,200
# 静态背景流设置为150
...
result = get_basic_result('1,5-7,36')
print(result)
data = result.T.values.tolist()


data_to_plot = {
    'Avg FCT':    ([0,50,100,150,200], data[4]),
    'Avg intra_flow FCT': ([0,50,100,150,200], data[5]),
    'Avg inter_flow FCT': ([0,50,100,150,200], data[6])
}
...
plot_auto_lines(
    ...
    filename="dynamic_flow_analysis_p99.pdf",
